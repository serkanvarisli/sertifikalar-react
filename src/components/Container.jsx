...
const Container = () => {
  return (
    <div className="container">
      <h2>Alanında Uzmanlaşmış Sertifikalar</h2>
      <ul>
        ...
        <li><a href="https://gelecegiyazanlar.turkcell.com.tr/certificate/dWlkMjc4ODE2Y2lkMzc0OTFxaWQxNDBlbmQ="
          target="_blank">Türkcell Geleceği Yazanlar-Java 101</a></li>
        <li><a href="https://gelecegiyazanlar.turkcell.com.tr/certificate/dWlkMjc4ODE2Y2lkMzc0OTJxaWQxNDFlbmQ="
          target="_blank">Türkcell Geleceği Yazanlar-Java 201</a></li>
